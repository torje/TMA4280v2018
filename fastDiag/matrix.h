...
class Matrix{
	...
	// Where a nodes matrix begins 
    size_t height_offset = 0;
	// The height of the local matrix, except for the last node
	...
	// The easy way to transpose a matrix is to have a evenly divisible dimension
	size_t easy_height = 0;
    size_t easy_width = 0;

	// A hack to allow the at functions to work
	double dummy;
public:
